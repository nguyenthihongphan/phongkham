            ...
            <div class="content">
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                echo $today;
								 ...
								 $benhan = $mysqli->query("select * from benhan inner join benhnhan on benhan.idbn=benhnhan.id");
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Danh sách bệnh án(<?php echo $benhan->num_rows; ?>)</p>
                    </td>
                ...
                <tr>
                    ...
                    <td width="12%">
                        <input type="submit"  name="filter" value=" Lọc" class=" btn-primary-soft btn btn-primary-two button-icon btn-filter"  style="padding: 15px; margin :0;width:100%">
                        </form>
                    </td>
                ...
                <?php
                    $sqlmain= "select benhan.id, benhan.idbn, benhan.chuandoan, benhan.kqdieutri, benhan.ngaykham, benhan.tenba, benhnhan.tenbn from benhan inner join benhnhan on benhan.idbn= benhnhan.id ";
                    if($_POST){
                        //print_r($_POST);
                        ...
                        if(!empty($_POST["ngaykham"])){
                            ...
                            $sqlmain.=" and benhan.ngaykham='$ngaykham' ";
                        };
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
												 <a class="dropdown-item" href="medicine.php?id='.$idba.'" ><i class="fa-light fa-capsules m-r-5"></i> Kê đơn thuốc</a>
                                                 
                                    <a class="dropdown-item" href="edit-benhan.php?id='.$idba.'"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
