...
<div class="col-sm-6">
 ...
 <div class="col-sm-6">
             <div class="form-group">
                                ...
                                <input class="form-control" type="time" id="giokham" name="giokham" />
                            </div>
...
<div class="col-sm-6">
             <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="giokham" name="soluong" />
                            </div>
   ...
   <?php
	...
	{	
		...
		if($ngaykham!='' && $giokham!='')
		{		
				if($p->themxoasua("INSERT INTO lichtrinh(idck,tenbs,ngaykham,giokham,soluong,idbs) VALUES ('$tenck' ,'$tenbs','$ngaykham','$giokham','$soluong','$idbs')")==1)
				{	
