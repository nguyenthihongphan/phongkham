...
<div class="col-sm-6">
             <div class="form-group">
                 ...
                 <div class="m-t-20 text-center">
                                ...
                                <input type="submit"  class="btn btn-primary submit-btn" data-dismiss="modal" id="them" name="them" value="Thêm thuốc"/>
                            </div>
   <?php
	...
	{	
		...
		if($donvitinh!='' && $xuatxu!='')
		{		
				 if($p->themxoasua("INSERT INTO chitietdonthuoc(idloaithuoc,xuatxu,donvitinh,gia,tenthuoc) VALUES ('$loai','$xuatxu','$donvitinh','$gia','$tenthuoc')")==1)
{	
