				...
				?>
                    ...
                    <aside class="col-md-4">
                        ...
                        <div class="widget post-widget">
                            <h5>Bài viết khác</h5>
                            <?php
							$p->blogkhac("select * from tintuc order by id desc")
							?>
                        </div>
                        ...
                        <div class="widget tags-widget">
                            ...
                            <ul class="tags">
                                ...
                                <li><a href="#." class="tag">dịch Covid-19</a></li>
                                <li><a href="#." class="tag">Sức khỏe</a></li>
                                <li><a href="#." class="tag">Gia đình</a></li>
                                <li><a href="#." class="tag">Thuốc</a></li>
                                <li><a href="#." class="tag">Y học</a></li>
                                <li><a href="#." class="tag">Lịch khám</a></li>
