							...
							<div class="card-body p-0">
								<div class="table-responsive">
									<table class="table mb-0">
										...
										<?php
										echo $q->lichkham("select benhnhan.id,benhnhan.tenbn,lichkham.tenbs,lichkham.lichngaykham,benhnhan.sdt from benhnhan inner join lichkham on benhnhan.id=lichkham.idbn  where lichkham.id order by lichkham.lichngaykham desc limit 3");
										?>
									</table>
								</div>
							</div>
